...
1. Login to the API with your [login details](https://bestestimate.nl/menu_mole.html)
...
#### CONTACT & LICENSE
Created by [@joostremmers](https://bestestimate.nl/index_myself.html). For more information as well as license agreements reference is made to [this page](https://bestestimate.nl/index_disclaimer.html). Reach out in case of questions.
